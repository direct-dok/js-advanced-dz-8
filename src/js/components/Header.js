    ...
    <div class="width-1600">
        <div class="header__wrapper">
            <div class="header__left-block">
                ...
                <svg width="26" height="27" viewBox="0 0 27 28" xmlns="http://www.w3.org/2000/svg"
                    class="header__icon">
                    <path
            ...
            <div class="header__right-block">
                <button type="button" @click="showNavigation = true" class="header__button-menu">
            ...
            <nav v-bind:class="{'header__wrapper-menu': true, 'navigation': true,'navigation__open-navigation': showNavigation}">
                <div class="navigation__wrapper">
                    ...
                    <ul class="navigation__menu">
                        ...
                        <li class="navigation__item-menu">
                            <a href="" class="navigation__link-menu">Man</a>
                            <ul class="navigation__submenu">
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Accesories</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Bags</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Denim</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">T-Shirts</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="" class="navigation__link-menu">Woman</a>
                            <ul class="navigation__submenu">
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Accesories</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Jackets & Coats</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Polos</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">T-Shirts</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Shirts</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="" class="navigation__link-menu">Kids</a>
                            <ul class="navigation__submenu">
                                <li class="navigation__item-submenu"><a href="#"
                                        class="navigation__link-submenu">Accesories</a></li>
                                <li class="navigation__item-submenu"><a href="#"
                    ...
                    <div class="navigation__close-nav" @click="showNavigation = false">
                        <svg width="12" height="12" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg"
                            class="cart__delete-icon-product header__icon">
                            <path
